...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
        	//session失效 判断username是否存在session 
        	HttpSession webSession = request.getSession();
        	Object id = webSession.getAttribute("id");
        	//System.out.print(id);
        	if(id == null){
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/leftSide.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="user-sysInfo" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
