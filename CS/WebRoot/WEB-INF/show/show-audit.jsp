...
<!-- 	    	<s:form action="show-auditIfPass" method="post"> -->
	  			...
	  			<s:iterator value="#request.getSkillInfos">
					...
					<tr>
						...
						<td colspan="2"><div align="center" style="color: red">				
	 						<a href="show-auditPass?skill_Id=${skill_Id }">通过</a></div> 
	 					</td> 
	 					<td colspan="2"><div align="center" style="color: red"> 
	 						<a href="show-auditPassNo?skill_Id=${skill_Id }">不通过</a></div>
						</td> 
<!-- 						<td> -->
<!-- 							<s:radio list="#{'已通过形式审核':'通过','不通过':'不通过'}" name="ifPass" value='通过'></s:radio> -->
<!-- 						</td> -->
<!-- 					</tr> -->
					
<!-- 					<tr id="tr_advice" style="display:none;"> -->
<!-- 						<td> -->
<!-- 							审核意见 -->
<!-- 						</td> -->
						
<!-- 						<td> -->
<!-- 							<textarea rows="5" cols="80" name="advice" id="advice"></textarea> -->
<!-- 						</td> -->
					</tr> 
