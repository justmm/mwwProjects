   					...
   					$.getJSON(url,args,function(data){
   						...
   						if(data.length==0){
   							...
   							for(var i=0;i<data.length;i++)
   							{
   								...
   								var listSecondName = data[i].listSecondName;
   								//alert(listSecondId);
   								$("#list2").append("<option value='"+listSecondId+"'>"+listSecondName+"</option>");
   							} 							
   						}
   					});
   				}
  ...
  <body>
    	<h2 align="center">技术信息填写</h2>
  		<form action="skill-save" method="post">
    		<table width="900" height="1224" border="1" align="center" cellspacing="0">
    			<tr>
    				...
    				<td width="243" height="45" align="center" valign="middle">
      				<label>
						<s:select name="t_TimeMin" list="{'2017','2018','2019','2020','2021','2022','2023','2024','2025','2026','2027','2028','2029','2030','2031','2032','2033','2034','2035'}" headerKey="-1" headerValue="--请选择--"  multiple="false"/>        
        			年至
    					<s:select name="t_TimeMax" list="{'2017','2018','2019','2020','2021','2022','2023','2024','2025','2026','2027','2028','2029','2030','2031','2032','2033','2034','2035'}" headerKey="-1" headerValue="--请选择--"  multiple="false"/>
    				年     
    				</label>
    				</td>
 				</tr>
    		...
    		<s:hidden name="status" value="待审核"/>
    		</table>
    		<center>
			<br>
